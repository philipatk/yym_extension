<?php
// Heading
$_['heading_title']          = ' Φόρμα BluePay Hosted';

// Text
$_['text_extension']         = 'Επεκτάσεις';
$_['text_success']           = 'Επιτυχία: Έχετε επεξεργαστεί τις πληροφορίες λογαρισμού Φόρμας BluePay Hosted!';
$_['text_edit']              = 'Επεξεργασία Φόρμας BluePay Hosted';
...
$_['text_authenticate']      = 'Έγκριση (Authorize)';
$_['text_release_ok']        = 'Η αποδέσμευση ήταν επιτυχημένη';
$_['text_release_ok_order']  = 'Η αποδέσμευση ήταν επιτυχημένη';
...
$_['text_column_date_added'] = 'Ημερομηνία Προσθήκης';
...
// Entry
$_['entry_account_name']     = 'Όνομα Λογαριασμού';
$_['entry_account_id']       = 'Κωδικός Λογαριασμού (ID)';
$_['entry_secret_key']       = 'Μυστικό Κλειδί (Secret Key)';
$_['entry_test']             = 'Κατάσταση Λειτουργίας';
...
$_['help_transaction']       = 'Η Πώληση χρεώνει άμεσα τον πελάτη. Η Έγκριση δεσμεύει το ποσό για μελλοντική χρέωση.';
...
// Error
$_['error_permission']       = 'Ειδοποίηση: Δεν έχετε άδεια να επεξεργαστείτε την πληρωμή BluePay!';
$_['error_account_name']      = 'Απαιτείται το όνομα λογαριασμού';
$_['error_account_id']        = 'Απαιτείται ο κωδικός λογαριασμού (ID)!';
$_['error_secret_key']        = 'Απαιτείται το μυστικό κλειδί (Secret Key)!';