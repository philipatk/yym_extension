...
$_['text_success']          = 'Επιτυχία: Έχετε επεξεργαστεί την αποστολή United States Postal Service!';
$_['text_edit']             = 'Επεξεργασία Αποστολής United States Postal Service';
...
$_['entry_postcode']        = 'Ταχυδρομικός Κώδικας (Zip Code)';
$_['entry_domestic']        = 'Εγχώριες Υπηρεσίες';
$_['entry_international']   = 'Διεθνείς Υπηρεσίες';
$_['entry_size']            = 'Μέγεθος';
$_['entry_container']       = 'Συσκευασία';
$_['entry_machinable']      = 'Μηχανικά Διαχειρίσιμο (Machinable)';
...
// Help
$_['help_dimension']        = 'Οι μέσες διαστάσεις πακέτων αποστολής. Διαστάσεις προϊόντων δεν υποστηρίζονται προς το παρόν.';
...
$_['help_weight_class']     = 'Ορίζεται σε λίβρες (pounds)';
$_['help_debug']            = 'Αποθηκεύει δεδομένα αποστολής/λήψης στο αρχείο καταγραφής σφαλμάτων του συστήματος.';

// Error
$_['error_permission']      = 'Ειδοποίηση: Δεν έχετε άδεια να επεξεργαστείτε την αποστολή United States Postal Service!';
$_['error_user_id']         = 'Απαιτείται το όνομα χρήστη (User ID)!';
$_['error_postcode']        = 'Απαιτείται ο ταχυδρομικός κώδικας!';
$_['error_width']           = 'Απαιτείται το πλάτος!';
$_['error_length']          = 'Απαιτείται το μήκος!';
$_['error_height']          = 'Απαιτείται το ύψος!';
$_['error_girth']           = 'Απαιτείται η περίμετρος!';